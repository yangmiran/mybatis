<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" errorPage="views/common/error.jsp" isELIgnored="false" %>
...
<script src="/testm/resources/js/jquery-3.5.1.min.js"></script>
	...
	*/
	...
	$.ajax({
		...
		success: function(data){
			...
			for(var i in json.list){
				values += "<tr><td>" + json.list[i].no + "</td><td><a href='/testm/ndetail?noticeno=" + json.list[i].no + "'>" 
	...
	$.ajax({
		...
		success: function(data){
			...
			var values = "";
			for(var i in json.list){
				values += "<tr><td>" + json.list[i].bnum + "</td><td><a href='/testm/bdetail?bnum=" + json.list[i].bnum + "'>" 
